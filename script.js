...
function coryHenry() {
  document.querySelector('.cimage').src = `${featuring[0].image}`;
  document.querySelector('.cname').innerHTML = featuring[0].name;
  document.querySelector('.cdescription').innerHTML = featuring[0].description;
  document.querySelector('.coverview').innerHTML = featuring[0].overview;
}

function richardBona() {
  document.querySelector('.rimage').src = `${featuring[1].image}`;
  document.querySelector('.rname').innerHTML = featuring[1].name;
  document.querySelector('.rdescription').innerHTML = featuring[1].description;
  document.querySelector('.roverview').innerHTML = featuring[1].overview;
}

function snarkyPuppy() {
  document.querySelector('.simage').src = `${featuring[2].image}`;
  document.querySelector('.sname').innerHTML = featuring[2].name;
  document.querySelector('.sdescription').innerHTML = featuring[2].description;
  document.querySelector('.soverview').innerHTML = featuring[2].overview;
}

function stanleyRandolph() {
  document.querySelector('.stimage').src = `${featuring[3].image}`;
  document.querySelector('.stname').innerHTML = featuring[3].name;
  document.querySelector('.stdescription').innerHTML = featuring[3].description;
  document.querySelector('.stoverview').innerHTML = featuring[3].overview;
}
